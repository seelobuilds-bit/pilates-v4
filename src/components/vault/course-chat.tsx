...
export function CourseChat({ courseId, courseName }: CourseChatProps) {
  ...
  if (loading) {
    return (
      <Card className="border-0 shadow-sm h-[65vh] min-h-[460px] lg:h-[600px] flex items-center justify-center">
  ...
  return (
    <Card className="border-0 shadow-sm h-[65vh] min-h-[460px] lg:h-[600px] flex flex-col">
      {/* Header */}
      <div className="p-4 border-b flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between bg-gray-50">
      ...
      {/* Reply indicator */}
      {replyTo && (
        <div className="px-4 py-2 bg-gray-50 border-t flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
