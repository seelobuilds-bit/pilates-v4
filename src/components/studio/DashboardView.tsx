            ...
            <CardContent className="p-6">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div className="text-white">
                  <h2 className="text-lg font-semibold mb-1 tracking-[0.01em]">Today&apos;s Overview</h2>
            ...
            <CardContent className="p-6">
              <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <h3 className="font-semibold tracking-[0.01em] text-gray-900">Today&apos;s Schedule</h3>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold tracking-[0.01em] text-gray-900">Needs Attention</h3>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold tracking-[0.01em] text-gray-900">Coming Up</h3>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold tracking-[0.01em] text-gray-900">Recent Activity</h3>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold tracking-[0.01em] text-gray-900">Studio Stats</h3>
