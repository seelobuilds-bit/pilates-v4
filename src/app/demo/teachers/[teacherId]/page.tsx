...
export default function TeacherDetailPage({
  ...
  async function savePayRate() {
    ...
    try {
      const res = await fetch(`/api/demo/teachers/${resolvedParams.teacherId}/pay-rate`, {
        method: "PUT",
  ...
  async function markInvoicePaid(invoiceId: string) {
    try {
      const res = await fetch(`/api/demo/teachers/${resolvedParams.teacherId}/invoices/${invoiceId}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/demo/teachers/${resolvedParams.teacherId}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          bio: teacher.bio,
