...
type AppRoute = "/(app)" | "/(app)/schedule" | "/(app)/inbox" | "/(app)/workspace" | "/(app)/profile" | "/(app)/reports" | "/(app)/people" | "/(app)/classes"

const APP_ROUTE_ALLOWLIST = new Set<AppRoute>(["/(app)", "/(app)/schedule", "/(app)/inbox", "/(app)/workspace", "/(app)/profile", "/(app)/reports", "/(app)/people", "/(app)/classes"])
